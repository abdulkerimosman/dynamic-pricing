...
const FiyatlandirmaKurali = sequelize.define('FiyatlandirmaKurali', {
  ...
  kanal_id:                 { type: DataTypes.INTEGER, allowNull: false },
  kategori_id:              { type: DataTypes.INTEGER, allowNull: false },
  komisyon_orani:           { type: DataTypes.DECIMAL(5, 4), allowNull: false },
  lojistik_gideri:          { type: DataTypes.DECIMAL(10, 2), defaultValue: 0 },
  kargo_ucreti:             { type: DataTypes.DECIMAL(10, 2), defaultValue: 0 },
